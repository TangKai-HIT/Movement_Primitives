% DMP test demo2: train DMP using batch locally weighted regression
clc; clear; close all;
...
%Save figures
saveas(gcf, 'results/test2/test2_LWR_linear2.fig');
saveas(gcf, 'results/test2/test2_LWR_linear2.jpg');